...
const GetOnlyStudent  =  async (req, res) => {
    let id = req.params.id;
    let studentModel = model[0];
    let data = await studentModel.find({"id":2003});
    res.send(data);
};
...
module.exports = { GetStudentData, GetOnlyStudent , DashboardIFrame, GetFileNames, DisplayMaterial, ShowMaterialTeacherDashboard, fileList, openFile, GetHelpPage };